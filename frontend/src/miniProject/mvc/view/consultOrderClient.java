...
public class consultOrderClient extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					consultOrderClient frame = new consultOrderClient();
					frame.setTitle("consult order client");
	...
	public consultOrderClient() {
		...
		controlerConsultOrderClient co = new controlerConsultOrderClient(this);
		...
		controlerConsultOrderClient ho = new 		controlerConsultOrderClient(this,"home");
