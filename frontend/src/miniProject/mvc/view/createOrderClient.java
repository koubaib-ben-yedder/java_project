...
public class createOrderClient extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					createOrderClient frame = new createOrderClient();
					frame.setTitle("create order client");
	...
	public createOrderClient() {
	   ...
	   controlerCreateOrderClient or = new controlerCreateOrderClient(this);
		...
		controlerCreateOrderClient or1 = new controlerCreateOrderClient(this,"home");
