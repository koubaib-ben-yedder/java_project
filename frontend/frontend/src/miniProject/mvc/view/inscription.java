...
public class inscription extends JFrame {
	...
	public inscription() {
		...
		controlerInscription ok = new controlerInscription(this);
		
		JButton btnNewButton = new JButton("ok");
		btnNewButton.addActionListener(ok);
		...
		controlerInscription login = new controlerInscription(this,"login");

		JButton btnNewButton1 = new JButton("login");
		btnNewButton1.addActionListener(login);
