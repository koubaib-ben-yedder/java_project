...
import miniProject.mvc.controler.controlerCreateProduct;
...
public class createProduct extends JFrame {
	...
	public createProduct() {
		...
		controlerCreateProduct pr = new controlerCreateProduct(this);
		...
		controlerCreateProduct pr1 = new controlerCreateProduct(this,"home");

		btnNewButton = new JButton("home");
		btnNewButton.addActionListener(pr1);
