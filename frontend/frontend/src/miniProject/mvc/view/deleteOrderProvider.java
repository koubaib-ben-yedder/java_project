...
import miniProject.mvc.controler.controlerDeleteOrderProvider;
...
public class deleteOrderProvider extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					deleteOrderProvider frame = new deleteOrderProvider();
					frame.setTitle("delete order provider");
	...
	public deleteOrderProvider() {
		...
		controlerDeleteOrderProvider cDOP = new controlerDeleteOrderProvider(this);
		
		JButton btnNewButton = new JButton("ok");
		btnNewButton.addActionListener(cDOP);
		...
		cDOP = new controlerDeleteOrderProvider(this,"home");

		JButton btnNewButton1 = new JButton("home");
		btnNewButton1.addActionListener(cDOP);
