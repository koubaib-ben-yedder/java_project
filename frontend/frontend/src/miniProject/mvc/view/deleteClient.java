...
import miniProject.mvc.controler.controlerDeleteClient;
...
public class deleteClient extends JFrame {
	...
	public deleteClient() {
		...
		controlerDeleteClient cl = new controlerDeleteClient(this);
		...
		controlerDeleteClient cl1 = new controlerDeleteClient(this,"home");
