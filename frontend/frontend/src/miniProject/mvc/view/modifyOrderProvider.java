...
public class modifyOrderProvider extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					modifyOrderProvider frame = new modifyOrderProvider();
					frame.setTitle("modify order provider");
	...
	public modifyOrderProvider() {
		...
		controlerModifyOrderProvider or = new controlerModifyOrderProvider(this);
		...
		controlerModifyOrderProvider or1 = new controlerModifyOrderProvider(this,"home");
